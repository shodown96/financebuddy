            ...
            <div className="mt-5 grid grid-cols-1 gap-3 sm:grid-cols-4">
                <div className="sm:col-span-2">
                    ...
                    <input
                        ...
                        inputMode="numeric"
                        className="mt-2 w-full rounded-xl border border-neutral-300 dark:border-neutral-700 bg-white dark:bg-neutral-800 px-4 py-2 text-neutral-900 dark:text-neutral-100 outline-none focus:ring-2 focus:ring-neutral-900 dark:focus:ring-neutral-300"
                    />
                </div>
